    ...
    scenarios: [
      {
        ...
        description:
          '中堅小売チェーンの担当者が「画面は見やすく、在庫管理はいい感じに」と曖昧に要望。要件定義でどこまで深掘りするかが問われます。',
        pmTip: 'PMの仕事①：要件を明確にする。「いい感じに」という曖昧な要求をそのまま進めると後でやり直しが発生します。PMは「何を作るか」を具体的に確認してから進めます。',
        docs: [
          {
            type: '議事録',
            title: '要件ヒアリング議事録（草案）',
...
次回までに画面要件とレポート要件を明確化する`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事③：情報を集める。前任者からの引き継ぎが不完全でも、PMは責任を転嫁せず自分から情報を集めてプロジェクトを正しい方向に向けます。',
        docs: [
          {
            type: '議事録',
            title: '前任PM引き継ぎメモ（断片）',
...
顧客への確認: 未完了`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事④：対立を解消する。関係者の意見が対立したとき、PMは中立の立場で話し合いの場を作り全員が納得できる方向を見つけます。',
        docs: [
          {
            type: '議事録',
...
PM: 両者の折り合いをどこに置くか検討が必要`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑤：関係者を把握する。「誰が意思決定者か」を早めに整理しておくことで後のトラブルを防げます。これをステークホルダー管理と呼びます。',
        docs: [
          {
            type: 'メール',
            title: '購買部長からの指摘メール',
...
PM: ステークホルダーマップの見直しが急務`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事②：変更を記録する。口頭で決まったことは後で「言った・言わない」のトラブルになりがちです。PMは変更内容を必ず文書に残す習慣が大切です。',
        docs: [
          {
            type: '議事録',
            title: '会議メモ',
            content: `顧客: 「検索に店舗カテゴリーも入れたい」
PM: 仕様変更の影響を確認する必要あり
担当: 仕様変更範囲を翌日までに取りまとめる`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事：見積もりは「定時ベース＋バッファ」で組む。残業を前提にした計画は最初から破綻が約束されています。',
    ...
    scenarios: [
      {
        ...
        description:
          '基本設計の途中で顧客が「ついでに店舗別の在庫アラートもほしい」と要望。変更管理としてどう対応するかが問われます。',
        pmTip: 'PMの仕事⑥：追加要求を管理する。顧客から「ついでに〇〇も」と言われることはよくあります。PMは工数とコストへの影響を確認してから判断します。',
        docs: [
          {
            type: 'メール',
            title: '顧客追加要求メール',
            content: `顧客: 「ついでに在庫アラート機能も届けたいです。納期を変えずに対応できますか？」`,
          },
        ],
        choices: [
          {
...
PM: 双方の主張を整理中。優先基準が必要`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑨：品質を守る。設計の問題を早めに直すほど後の修正コストは小さくて済みます。PMは品質ゲートを守る役割があります。',
        docs: [
          {
            type: '課題管理表',
            title: '設計品質レビュー指摘事項',
...
対応方針: 未定`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑩：問題を整理する。ベンダー間で問題が起きたとき、PMは責任追及より先に「何が起きているか」を整理して関係者に共有します。',
        docs: [
          {
            type: '課題管理表',
...
期限: 2営業日以内`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事：見積もりは「誰がやるか」で変わる。過去実績は参考値であり、現チームのスキルと経験で補正するのがPMの責任です。',
    ...
    scenarios: [
      {
        ...
        pmTip: 'PMの仕事⑪：QCDのバランスをとる。QCDとは品質・コスト・納期の3つです。どれを優先するかを判断しチームに方針を示すのがPMの役割です。',
        docs: [
          {
            type: '課題管理表',
            title: '製造工程スケジュール圧迫',
...
対応: 体制・スコープ・品質の見直し`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑫：チームを補強する。メンバーのスキル不足に気づいたとき、PMは責めるのではなくどうフォローするかを考えます。',
        docs: [
          {
            type: '課題管理表',
            title: 'PG進捗乖離報告',
...
対応: スキル評価と補強策の検討が必要`,
      ...
      },
      {
        ...
        description:
          '実装中の決済システムとのAPI連携部分について、外部ベンダーから「来月より認証方式をOAuth2.0に変更する」と通知が届いた。現在の実装が全て変更対象になる可能性があり、工数への影響が不明です。',
        pmTip: 'PMの仕事⑬：変化に対応する。外部からの予期しない変更が来たとき、PMは冷静に影響を確認して計画を調整します。',
        docs: [
          {
            type: 'メール',
...
PM: 影響範囲の確認が急務`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑭：段取りをする。開発に必要な環境が整っていないとき、PMは代替策を素早く考えてチームが止まらないようにします。',
        docs: [
          {
            type: '課題管理表',
            title: 'テスト環境遅延報告',
...
現在の開発進捗: 予定通り`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑮：実態を把握する。「順調です」という報告を鵜呑みにせず、証拠で確認するのがPMの習慣です。これが後の炎上を防ぎます。',
        docs: [
          {
            type: 'メール',
            title: '進捗報告メール',
...
PM: 実装成果物の共有を依頼`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事：質問できる空気を作る。心理的安全性がないと、問題は隠れ、手戻りが増えます。「聞きやすい環境」はPMが作ります。',
    ...
    scenarios: [
      {
        ...
        pmTip: 'PMの仕事⑯：問題を収束させる。テストで大きな問題が発覚したとき、PMはパニックにならず原因と影響を整理してから対策を立てます。',
        docs: [
          {
            type: '課題管理表',
...
対応: 仕様調整と改修の優先度決定`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑰：要件を守る。性能が要件を満たさないとき、PMは顧客と正直に話し合って対応策を決めます。隠すより早めの報告が信頼を守ります。',
        docs: [
          {
            type: 'リスク管理表',
            title: '性能テスト結果報告',
...
ボトルネック: DB検索クエリの最適化不足`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑱：根本を解決する。同じ問題が繰り返されるとき、PMは表面的な対処より根本原因の解決を選びます。',
        docs: [
          {
            type: '課題管理表',
            title: 'リグレッション発生状況',
...
テスト完了予測: 現状では不明`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑲：品質を保証する。テスト内容が不十分なまま納品すると後で大きな問題になります。PMは品質を保証する最後の砦です。',
        docs: [
          {
            type: '課題管理表',
...
リスク: 本番で想定外の障害が発生する可能性が高い`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事⑳：品質と納期のバランスをとる。重大なバグが見つかったとき、「このまま出してもいいか」を判断するのはPMです。勇気ある報告が大切です。',
        docs: [
          {
            type: 'メール',
            title: '社内報告メール',
...
提案: 直ちに対応か、リリース延期の検討`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事：終盤の「ついで」を管理する。スコープクリープは終盤が最も危険です。変更管理プロセスを使い「全て受けない・全て断わらない」バランスを保ちます。',
    ...
    scenarios: [
      {
        ...
        pmTip: 'PMの仕事㉑：記録で守る。顧客から「要件と違う」と言われたとき、議事録や合意書が重要な根拠になります。記録を残す習慣がPMを守ります。',
        docs: [
          {
            type: '議事録',
            title: '受入テスト報告書',
...
担当: 要件定義資料と議事録の確認`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事㉒：調整する。顧客側の準備が遅れているとき、PMは状況を確認して現実的な対応策を選びます。',
        docs: [
          {
            type: 'メール',
...
PM: 影響と選択肢の整理が必要`,
      ...
      },
      {
        ...
        description:
          '本番リリース後2時間で、既存データの移行漏れによりシステム上の在庫数と実際の在庫数が大幅に乖離していることが発覚。顧客から「業務が回らない、すぐ対応してほしい」と緊急連絡が入っています。',
...
PM: 対応方針の決定が必要`,
      ...
      },
      {
        ...
        pmTip: 'PMの仕事㉕：最終判断をする。リリースするかしないかの最終判断を下すのがPMです。リスクと顧客への影響を天秤にかけて決断します。',
        docs: [
          {
            type: 'リスク管理表',
            title: '本番リリース判断資料',
