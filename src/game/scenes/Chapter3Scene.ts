...
const NPCS: NpcDef[] = [
  { name: '田中PM',   col: 2,  row: 1, lines: ['第3章は基本設計フェーズだ', '要件定義書をベースに基本設計書を作ってくれ', 'テンプレ？前のプロジェクトのを流用していいよ', '品質と納期、両方守れるよね？(圧)', '細かい部分は現場のノリで察してくれ！'] },
  { name: '佐藤先輩', col: 9, row: 3, lines: ['設計、順調？要件との整合性に気をつけてね', '表向きは『テンプレ通りでOK』なんだけど', '実際はお客さんのこだわりが後から出てくるから', '行間を読む力が必要になるんだよね'] },
  { name: '鈴木さん', col: 14, row: 9, lines: ['元請けの設計書って、結構雑なんですよね…', '『行間を読め』ってよく言われるんですけど', '行間に何も書いてないんですよ', 'うちは下請けなんで、ちゃんと書いとかないと痛い目見るんです'] },
];
